...
<nav class="navbar navbar-default" role="navigation">
    <div class="navbar-header">
        ...
        <form method="GET"><a class="navbar-brand" href="displayinfo.jsp"><i class="fa fa-user" aria-hidden="true"></i></a></form>
    </div>
...
<div class="container" style="margin-left:300px">
	...
	age			:	${empInfo.age }<br>
	gender		:	${empInfo.gender }<br>
	salary		:	${empInfo.salary }<br>
	phone		:	${empInfo.phone }<br>
	joiningDate	:	${empInfo.joiningDate }<br>
	accountNumber:	${empInfo.accountNumber }<br>
	designation	:	${empInfo.designation }<br>
	dob			:	${empInfo.dob }<br>
	departmentId:	${empInfo.departmentId }<br>
	managerId	:	${empInfo.managerId }<br>
	password	:	${empInfo.password }<br>
</div>
