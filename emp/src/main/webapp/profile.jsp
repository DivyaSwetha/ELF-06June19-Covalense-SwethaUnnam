	...
	<div class="container mt-4">
		...
		<nav class="navbar navbar-default" role="navigation">
			<div class="navbar-header">
				...
				<form method="GET">
					<a class="navbar-brand" href="/empnew/profile.jsp"><i
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><form action="/emp/empinfo" method="POST">
									<input type="submit" value="Employee Info">
								</form></li>
							<li><form action="/emp/empinfo">
									<a href="#"><input type="submit"
										value="Employee Other Info"></a>
								</form></li>
							<li><form action="/emp/empinfo">
									<a href="#"><input type="submit" value="Department Info"></a>
								</form></li>
							<li class="divider"></li>
				...
				<div class="col-sm-3 col-md-3 pull-right">
					<form class="navbar-form" role="search" action="/emp/empsearch">
						<div class="input-group">
							<input type="text" class="form-control"
								placeholder="Search with id..." name="id">
